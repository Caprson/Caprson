...
function TableRow({ row }) {
    ...
    return (
        <tr className="group hover:bg-neutral-100 h-[40px]">
            ...
            <td className="w-[120px] px-4  overflow-hidden whitespace-nowrap text-ellipsis border-b border-r border-gray-300 text-left text-gray-700">{row.key}</td>
            <td className="px-4 w-[400px]  overflow-hidden whitespace-nowrap text-ellipsis border-b border-r border-gray-300 text-left text-gray-700">{row.summary}</td>
            ...
            <td className="px-4 w-[145px]  overflow-hidden whitespace-nowrap text-ellipsis border-b border-r border-gray-300 text-left">{row.sprint}</td>
