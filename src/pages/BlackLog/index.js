                                ...
                                >
                                    ...
                                    {isCreating ? (
                                        <input
                                            ...
                                            className="w-full mt-1 block px-2 py-3 border-solid bg-white border border-slate-300 rounded-md text-   xl shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 "
